...
extern void gl_alpha_func(GLenum func, GLclampf ref) NINECRAFT_FLOAT_FUNC;
...
extern void gl_clear_color(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) NINECRAFT_FLOAT_FUNC;

extern void gl_color_4_f(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) NINECRAFT_FLOAT_FUNC;
...
extern void gl_depth_range_f(GLclampf near, GLclampf far) NINECRAFT_FLOAT_FUNC;
...
extern void gl_fog_f(GLenum pname, GLfloat param) NINECRAFT_FLOAT_FUNC;

extern void gl_fog_f_v(GLenum pname, const GLfloat *params) NINECRAFT_FLOAT_FUNC;

extern void gl_fog_x(GLenum pname, GLfixed param);

extern void gl_gen_textures(GLsizei n, GLuint *textures);

extern void gl_get_float_v(GLenum pname, GLfloat *params) NINECRAFT_FLOAT_FUNC;

extern const GLubyte *gl_get_string(GLenum name);

extern void gl_hint(GLenum target, GLenum mode);

extern void gl_line_width(GLfloat width) NINECRAFT_FLOAT_FUNC;

extern void gl_load_identity();

extern void gl_matrix_mode(GLenum mode);

extern void gl_mult_matrix_f(const GLfloat *m) NINECRAFT_FLOAT_FUNC;

extern void gl_normal_3_f(GLfloat nx, GLfloat ny, GLfloat nz) NINECRAFT_FLOAT_FUNC;

extern void gl_ortho_f(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far) NINECRAFT_FLOAT_FUNC;

extern void gl_polygon_offset(GLfloat factor, GLfloat units) NINECRAFT_FLOAT_FUNC;
...
extern void gl_rotate_f(GLfloat angle, GLfloat x, GLfloat y, GLfloat z) NINECRAFT_FLOAT_FUNC;

extern void gl_scale_f(GLfloat x, GLfloat y, GLfloat z) NINECRAFT_FLOAT_FUNC;
...
extern void gl_translate_f(GLfloat x, GLfloat y, GLfloat z) NINECRAFT_FLOAT_FUNC;
...
extern void gl_light_model_f(GLenum pname, GLfloat param) NINECRAFT_FLOAT_FUNC;

extern void gl_light_f_v(GLenum light, GLenum pname, const GLfloat *params) NINECRAFT_FLOAT_FUNC;
