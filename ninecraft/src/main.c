...
static void key_callback(GLFWwindow *window, int key, int scancode, int action, int mods) {
    if (key == GLFW_KEY_F11) {
        ...
        if (key == GLFW_KEY_Q && action == GLFW_PRESS && mouse_pointer_hidden && version_id >= version_id_0_5_0 && version_id <= version_id_0_9_5) {
                ...
                if (!is_creative) {
                    ...
                    if (item_instance) {
                        ...
                        if (!is_empty) {
                            ...
                            } else if (version_id >= version_id_0_7_2 && version_id <= version_id_0_9_5) {
    ...
    if (version_id >= version_id_0_5_0 && version_id <= version_id_0_9_5 && minecraft_options_offset) {
        if (version_id >= version_id_0_7_0 && options_set_key) {
            ...
            if (options_keys_offset) {
                ...
                *(int *)((char *)options_keys[MCKEY_ID_DROP] + android_string_tsize()) = MCKEY_DROP;
            }
        }
    }
